...
data_preprocessor = dict(
    ...
    seg_pad_val=0,
    size=(512, 512))
checkpoint_file = '/gpfs/share/home/2001110054/Fault_Recong/mmpretrain/output/simmim_swin-base-w7_2000e_512x512_mix_v2_force_3_chan_per_image_norm_rerun/epoch_2000.pth'
model = dict(
    type='EncoderDecoder',
...
project_data_root_lst = ['../Fault_data/real_labeled_data/2d_slices', '../Fault_data/project_data_v1/labeled/qyb/2d_slices_sl', '../Fault_data/project_data_v1/labeled/Ordos/gjb/2d_slices_sl', '../Fault_data/project_data_v1/labeled/Ordos/pl/2d_slices_sl', '../Fault_data/project_data_v1/labeled/Ordos/yw/2d_slices_sl',
                         '../Fault_data/project_data_v2/GYX/2d_slices_sl', '../Fault_data/project_data_v2/LH3D/2d_slices_sl', '../Fault_data/project_data_v2/ZG3D/2d_slices_sl', '../Fault_data/project_data_v3/dafeng1/2d_slices_sl', '../Fault_data/project_data_v3/guai3east/2d_slices_sl_inline', '../Fault_data/project_data_v3/guai3east/2d_slices_sl_xline', '../Fault_data/project_data_v3/madonglianpian/2d_slices_sl_inline', '../Fault_data/project_data_v3/madonglianpian/2d_slices_sl_xline']
