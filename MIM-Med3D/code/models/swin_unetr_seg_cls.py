...
__all__ = ["SwinUNETR_Seg_Cls"
]


class SwinUNETR_Seg_Cls(nn.Module):
    """
    ...
    def __init__(
        ...
        #  add for cls
        cls_feature_size = 16 * feature_size
        for _img_size in img_size:
            cls_feature_size *= (_img_size // 32)
        self.cls_out = nn.Linear(in_features=cls_feature_size, out_features=1)
