...
data_preprocessor = dict(
    ...
    seg_pad_val=0,
    size=(512, 512))
checkpoint_file = '/gpfs/share/home/2001110054/Fault_Recong/mmpretrain/output/simmim_swin-base-w7_1000e_512x512_mix_force_3_chan_per_image_norm/epoch_1000.pth'
model = dict(
    type='EncoderDecoder',
