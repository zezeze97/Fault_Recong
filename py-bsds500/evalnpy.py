...
model_name = "swin_base_upernet_mix_data" #********
print("model_name",model_name)

gtpath = '/home/zhangzr/Fault_Recong/py-bsds500/thebe_gt'
Predpath = '/home/zhangzr/Fault_Recong/py-bsds500/swin_pred'
print(Predpath)
fault = np.load('/home/zhangzr/Fault_Recong/Fault_data/public_data/precessed/test/fault/faulttest.npy', mmap_mode='r')
...
def load_pred(sample_name):
    ...
    pred = cv2.resize(pred[:,UPPER_BOUND:LOWER_BOUND],(w_s,h_s))
    return pred
